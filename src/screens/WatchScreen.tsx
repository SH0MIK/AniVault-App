...
const styles = StyleSheet.create({
  ...
  titleBlock: { paddingHorizontal: 16, paddingTop: 14 }, mainTitle: { color: '#fff', fontSize: 21, lineHeight: 26, fontWeight: '800', fontFamily: fonts.bodyBold }, episodeTitleText: { color: 'rgba(255,255,255,.7)', fontSize: 13, lineHeight: 18, marginTop: 4, fontFamily: fonts.bodyMedium }, metaRow: { flexDirection: 'row', alignItems: 'center', marginTop: 6 }, metaText: { color: 'rgba(255,255,255,.5)', fontSize: 12, fontFamily: fonts.body }, moreLink: { color: 'rgba(255,255,255,.85)', fontSize: 12, fontWeight: '800', marginLeft: 6, fontFamily: fonts.bodySemibold }, episodeSynopsis: { color: 'rgba(255,255,255,.55)', fontSize: 12, lineHeight: 18, marginTop: 10 },
  ...
  episodeList: { marginTop: 16 }, episodeListRow: { minHeight: 124, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, gap: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: 'rgba(255,255,255,.06)' }, episodeListRowActive: { backgroundColor: 'rgba(255,255,255,.05)' }, listThumbWrap: { width: 100, height: 100, borderRadius: 9, overflow: 'hidden', backgroundColor: '#15151a', position: 'relative' }, listThumb: { width: '100%', height: '100%' }, listThumbFallback: { ...StyleSheet.absoluteFillObject, backgroundColor: '#15151a' }, listPlayMark: { position: 'absolute', left: 7, bottom: 7 }, imageEpisodeBadge: { position: 'absolute', top: 7, left: 7, height: 20, paddingHorizontal: 7, borderRadius: 5, backgroundColor: 'rgba(0,0,0,.75)', alignItems: 'center', justifyContent: 'center' }, imageEpisodeText: { color: '#fff', fontSize: 10, fontWeight: '900' }, listCopy: { flex: 1, minWidth: 0 }, listTitle: { color: '#fff', fontSize: 14, lineHeight: 19, fontWeight: '700', fontFamily: fonts.bodySemibold }, listMetaRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8, gap: 8 }, listBadge: { height: 20, paddingHorizontal: 7, borderRadius: 5, backgroundColor: 'rgba(255,255,255,.12)', alignItems: 'center', justifyContent: 'center' }, listBadgeText: { color: '#fff', fontSize: 10, fontWeight: '800' }, listDate: { color: 'rgba(255,255,255,.4)', fontSize: 11, fontFamily: fonts.body }, listSynopsis: { color: 'rgba(255,255,255,.4)', fontSize: 10, lineHeight: 15, marginTop: 7 }, listDownload: { paddingLeft: 4 }, sectionTitle: { color: '#fff', fontSize: 12, fontWeight: '900', letterSpacing: .8 }, about: { marginHorizontal: 16, marginTop: 22, paddingTop: 18, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,.08)' }, synopsis: { color: 'rgba(255,255,255,.5)', fontSize: 11, lineHeight: 18, marginTop: 10 },
});